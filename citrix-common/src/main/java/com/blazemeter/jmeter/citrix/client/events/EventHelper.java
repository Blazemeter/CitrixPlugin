...
public class EventHelper {
	...
	public static Set<MouseButton> toButtons(final int value) {
		...
		if (copy != 0) {
			LOGGER.warn("Converting integer value to set of buttons: Value {} contains unsupported flags {}", value,
	...
	public static Set<Modifier> toModifiers(final int value) {
		...
		if (copy != 0) {
			LOGGER.warn("Converting integer value to set of modifiers: Value {} contains unsupported flags {}", value,
					Integer.toBinaryString(copy));
		}
		return result;
	}
