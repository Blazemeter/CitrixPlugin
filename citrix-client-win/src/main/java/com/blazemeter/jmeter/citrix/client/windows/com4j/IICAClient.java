...
public interface IICAClient extends Com4jObject {
   ...
   * </p>
   *
   * @param name Mandatory String parameter.
   */
  ...
  @VTID(13)
  void deletePropByIndex(int index);
   ...
   *
   * @param name  Mandatory String parameter.
   * @param value Mandatory String parameter.
   */
  ...
  @VTID(18)
  String getPropValueByIndex(int index);
   ...
   * </p>
   *
   * @param file Mandatory String parameter.
   */
   ...
   * </p>
   *
   * @param appName   Mandatory String parameter.
   * @param arguments Mandatory String parameter.
   */

  @DISPID(14) //= 0xe. The runtime will prefer the VTID if present
  @VTID(23)
  void runPublishedApplication(String appName, String arguments);
   ...
   * </p>
   *
   * @param action Mandatory ICASessionEndAction parameter.
   */
  @DISPID(15) //= 0xf. The runtime will prefer the VTID if present
  @VTID(24)
  void setSessionEndAction(ICASessionEndAction action);
   ...
   * </p>
   *
   * @param index Mandatory ICASessionString parameter.
   * @return Returns a value of type String
   */
  @DISPID(19) //= 0x13. The runtime will prefer the VTID if present
  @VTID(28)
  String getSessionString(ICASessionString index);
   ...
   * </p>
   *
   * @param index Mandatory ICASessionCounter parameter.
   * @return Returns a value of type int
   */

  @DISPID(20) //= 0x14. The runtime will prefer the VTID if present
  @VTID(29)
  int getSessionCounter(ICASessionCounter index);
   ...
   * </p>
   *
   * @return Returns a value of type ICAEvent
   */
   ...
   * </p>
   *
   * @param channelNames Mandatory String parameter.
   * @return Returns a value of type int
   */

  @DISPID(33) //= 0x21. The runtime will prefer the VTID if present
  @VTID(42)
  int createChannels(String channelNames);
   ...
   * </p>
   *
   * @param channelName Mandatory String parameter.
   * @param data        Mandatory String parameter.
   * @param dataSize    Mandatory int parameter.
   * @param dataType    Mandatory ICAVCDataType parameter.
   * @return Returns a value of type int
   */

  @DISPID(34) //= 0x22. The runtime will prefer the VTID if present
  @VTID(43)
  int sendChannelData(String channelName, String data, int dataSize, ICAVCDataType dataType);
  ...
  @VTID(46)
  int getChannelNumber(String channelName);
  ...
  @VTID(48)
  String getGlobalChannelName(int channelIndex);
  ...
  @VTID(49)
  int getGlobalChannelNumber(String channelName);
  ...
  @VTID(53)
  int setChannelFlags(String channelName, int flags);
  ...
  @VTID(54)
  int getChannelFlags(String channelName);
  ...
  @VTID(55)
  int getChannelDataSize(String channelName);
   ...
   *
   * @param channelName Mandatory String parameter.
   * @return Returns a value of type ICAVCDataType
   */

  @DISPID(47) //= 0x2f. The runtime will prefer the VTID if present
  @VTID(56)
  ICAVCDataType getChannelDataType(String channelName);
  ...
  @VTID(57)
  String getChannelData(String channelName, ICAVCDataType dataType);
  ...
  @VTID(61)
  int getEnumNameCount(int hndEnum);
  ...
  @VTID(62)
  String getEnumNameByIndex(int hndEnum, int hndIndex);
  ...
  @VTID(63)
  int closeEnumHandle(int hndEnum);
   ...
   * </p>
   *
   * @param wndType  Mandatory ICAWindowType parameter.
  ...
  @VTID(64)
  int getWindowWidth(ICAWindowType wndType, int wndFlags);
  ...
  @VTID(65)
  int getWindowHeight(ICAWindowType wndType, int wndFlags);
  ...
  @VTID(66)
  int setWindowSize(ICAWindowType wndType, int width, int height, int wndFlags);
  ...
  @VTID(67)
  int getWindowXPosition(ICAWindowType wndType, int wndFlags);
  ...
  @VTID(68)
  int getWindowYPosition(ICAWindowType wndType, int wndFlags);
  ...
  @VTID(69)
  int setWindowPosition(ICAWindowType wndType, int xPos, int yPos, int wndFlags);
  ...
  @VTID(70)
  int displayWindow(ICAWindowType wndType);
  ...
  @VTID(71)
  int hideWindow(ICAWindowType wndType);
  ...
  @VTID(92)
  int newWindow(int xPos, int yPos, int width, int height, int flags);
  ...
  @VTID(95)
  String getClientErrorMessage(int errCode);
  ...
  @VTID(104)
  String getClientAddress(int index);
   ...
   * </p>
   *
   * @param pSessionId Mandatory String parameter.
   * @return Returns a value of type int
   */

  @DISPID(97) //= 0x61. The runtime will prefer the VTID if present
  @VTID(105)
  int attachSession(String pSessionId);
  ...
  @VTID(106)
  int detachSession(String pSessionId);
  ...
  @VTID(108)
  boolean isSessionAttached(String pSessionId);
  ...
  @VTID(109)
  boolean isSessionDetached(String pSessionId);
  ...
  @VTID(110)
  boolean isSessionRunning(String pSessionId);
  ...
  @VTID(111)
  int setSessionId(String pSessionId);
   ...
   * </p>
   *
   * @param pVal Mandatory String parameter.
   */
   ...
   * </p>
   *
   * @return Returns a value of type ICASoundQuality
   */
   ...
   * </p>
   *
   * @param pVal Mandatory ICASoundQuality parameter.
   */

  @DISPID(1026) //= 0x402. The runtime will prefer the VTID if present
  @VTID(119)
  void audioBandwidthLimit(ICASoundQuality pVal);
  ...
  @DISPID(1034) //= 0x40a. The runtime will prefer the VTID if present
  @VTID(134)
  void connectionEntry(String pVal);
  ...
  @DISPID(1036) //= 0x40c. The runtime will prefer the VTID if present
  @VTID(138)
  void customMessage(String pVal);
   ...
   * </p>
   *
   * @return Returns a value of type ICAColorDepth
   */
   ...
   * </p>
   *
   * @param pVal Mandatory ICAColorDepth parameter.
   */

  @DISPID(1038) //= 0x40e. The runtime will prefer the VTID if present
  @VTID(142)
  void desiredColor(ICAColorDepth pVal);
  ...
  @DISPID(1047) //= 0x417. The runtime will prefer the VTID if present
  @VTID(159)
  void initialProgram(String pVal);
  ...
  @DISPID(1048) //= 0x418. The runtime will prefer the VTID if present
  @VTID(161)
  void ipxBrowserAddress(String pVal);
  ...
  @DISPID(1049) //= 0x419. The runtime will prefer the VTID if present
  @VTID(163)
  void netbiosBrowserAddress(String pVal);
  ...
  @DISPID(1051) //= 0x41b. The runtime will prefer the VTID if present
  @VTID(166)
  void persistentCacheEnabled(boolean pVal);
  ...
  @DISPID(1052) //= 0x41c. The runtime will prefer the VTID if present
  @VTID(168)
  void protocolSupport(String pVal);
   ...
   * </p>
   *
   * @return Returns a value of type ICASessionEndAction
   */
   ...
   * </p>
   *
   * @param pVal Mandatory ICASessionEndAction parameter.
   */

  @DISPID(1054) //= 0x41e. The runtime will prefer the VTID if present
  @VTID(172)
  void sessionEndAction(ICASessionEndAction pVal);
  ...
  @DISPID(1056) //= 0x420. The runtime will prefer the VTID if present
  @VTID(176)
  void tcpBrowserAddress(String pVal);
  ...
  @DISPID(1057) //= 0x421. The runtime will prefer the VTID if present
  @VTID(178)
  void transportDriver(String pVal);
  ...
  @DISPID(1059) //= 0x423. The runtime will prefer the VTID if present
  @VTID(182)
  void updatesAllowed(boolean pVal);
  ...
  @DISPID(1064) //= 0x428. The runtime will prefer the VTID if present
  @VTID(190)
  void winstationDriver(String pVal);
  ...
  @DISPID(1065) //= 0x429. The runtime will prefer the VTID if present
  @VTID(192)
  void workDirectory(String pVal);
  ...
  @DISPID(1090) //= 0x442. The runtime will prefer the VTID if present
  @VTID(228)
  void encryptionLevelSession(String pVal);
  ...
  @DISPID(1091) //= 0x443. The runtime will prefer the VTID if present
  @VTID(230)
  void httpBrowserAddress(String pVal);
  ...
  @DISPID(1102) //= 0x44e. The runtime will prefer the VTID if present
  @VTID(232)
  void browserProtocol(String pVal);
  ...
  @DISPID(1103) //= 0x44f. The runtime will prefer the VTID if present
  @VTID(234)
  void locHTTPBrowserAddress(String pVal);
  ...
  @DISPID(1104) //= 0x450. The runtime will prefer the VTID if present
  @VTID(236)
  void locIPXBrowserAddress(String pVal);
  ...
  @VTID(237)
  String locNETBIOSBrowserAddress();
  ...
  @DISPID(1105) //= 0x451. The runtime will prefer the VTID if present
  @VTID(238)
  void locNETBIOSBrowserAddress(String pVal);
  ...
  @DISPID(1106) //= 0x452. The runtime will prefer the VTID if present
  @VTID(240)
  void locTCPBrowserAddress(String pVal);
  ...
  @DISPID(1107) //= 0x453. The runtime will prefer the VTID if present
  @VTID(242)
  void doNotUseDefaultCSL(boolean pVal);
   ...
   * </p>
   *
   * @return Returns a value of type ICAScalingMode
   */
   ...
   * </p>
   *
   * @param pVal Mandatory ICAScalingMode parameter.
   */

  @DISPID(1113) //= 0x459. The runtime will prefer the VTID if present
  @VTID(254)
  void scalingMode(ICAScalingMode pVal);
  ...
  @DISPID(1116) //= 0x45c. The runtime will prefer the VTID if present
  @VTID(260)
  void virtualChannels(String pVal);
  ...
  @DISPID(1117) //= 0x45d. The runtime will prefer the VTID if present
  @VTID(262)
  void useAlternateAddress(int pVal);
  ...
  @DISPID(1121) //= 0x461. The runtime will prefer the VTID if present
  @VTID(270)
  void icasocksProtocolVersion(int pVal);
  ...
  @DISPID(1122) //= 0x462. The runtime will prefer the VTID if present
  @VTID(272)
  void icasocksProxyHost(String pVal);
  ...
  @DISPID(1123) //= 0x463. The runtime will prefer the VTID if present
  @VTID(274)
  void icasocksProxyPortNumber(int pVal);
  ...
  @VTID(275)
  String icasocksrfC1929Username();
  ...
  @DISPID(1124) //= 0x464. The runtime will prefer the VTID if present
  @VTID(276)
  void icasocksrfC1929Username(String pVal);
  ...
  @DISPID(1131) //= 0x46b. The runtime will prefer the VTID if present
  @VTID(288)
  void sslCommonName(String pVal);
  ...
  @VTID(291)
  String xmlAddressResolutionType();
  ...
  @DISPID(1134) //= 0x46e. The runtime will prefer the VTID if present
  @VTID(292)
  void xmlAddressResolutionType(String pVal);
  ...
  @DISPID(1136) //= 0x470. The runtime will prefer the VTID if present
  @VTID(296)
  void autoAppResize(boolean pVal);
  ...
  @DISPID(1158) //= 0x486. The runtime will prefer the VTID if present
  @VTID(336)
  void hotkey10Shift(String pVal);
  ...
  @DISPID(1159) //= 0x487. The runtime will prefer the VTID if present
  @VTID(338)
  void controlWindowText(String pVal);
  ...
  @DISPID(1160) //= 0x488. The runtime will prefer the VTID if present
  @VTID(340)
  void cacheICAFile(boolean pVal);
  ...
  @DISPID(1164) //= 0x48c. The runtime will prefer the VTID if present
  @VTID(346)
  void transportReconnectEnabled(boolean pVal);
  ...
  @DISPID(1165) //= 0x48d. The runtime will prefer the VTID if present
  @VTID(348)
  void transportReconnectDelay(int pVal);
  ...
  @DISPID(1166) //= 0x48e. The runtime will prefer the VTID if present
  @VTID(350)
  void transportReconnectRetries(int pVal);
  ...
  @DISPID(1167) //= 0x48f. The runtime will prefer the VTID if present
  @VTID(352)
  void autoLogonAllowed(boolean pVal);
  ...
  @DISPID(1168) //= 0x490. The runtime will prefer the VTID if present
  @VTID(354)
  void enableSessionSharingClient(boolean pVal);
  ...
  @DISPID(1169) //= 0x491. The runtime will prefer the VTID if present
  @VTID(356)
  void sessionSharingName(String pVal);
  ...
  @DISPID(1170) //= 0x492. The runtime will prefer the VTID if present
  @VTID(358)
  void sessionSharingLaunchOnly(boolean pVal);
  ...
  @DISPID(1171) //= 0x493. The runtime will prefer the VTID if present
  @VTID(360)
  void disableCtrlAltDel(boolean pVal);
  ...
  @DISPID(1172) //= 0x494. The runtime will prefer the VTID if present
  @VTID(362)
  void sessionCacheEnable(boolean pVal);
  ...
  @DISPID(1173) //= 0x495. The runtime will prefer the VTID if present
  @VTID(364)
  void sessionCacheTimeout(int pVal);
   ...
   * </p>
   *
   * @return Returns a value of type ISession
   */
   ...
   * </p>
   *
   * @return Returns a value of type OutputMode
   */
   ...
   * </p>
   *
   * @param pVal Mandatory OutputMode parameter.
   */

  @DISPID(1176) //= 0x498. The runtime will prefer the VTID if present
  @VTID(367)
  void outputMode(OutputMode pVal);
  ...
  @DISPID(1178) //= 0x49a. The runtime will prefer the VTID if present
  @VTID(369)
  void sessionExitTimeout(int pVal);
  ...
  @DISPID(1179) //= 0x49b. The runtime will prefer the VTID if present
  @VTID(371)
  void enableSessionSharingHost(boolean pVal);
  ...
  @DISPID(1180) //= 0x49c. The runtime will prefer the VTID if present
  @VTID(373)
  void longCommandLine(String pVal);
  ...
  @DISPID(1181) //= 0x49d. The runtime will prefer the VTID if present
  @VTID(375)
  void twiDisableSessionSharing(boolean pVal);
  ...
  @DISPID(1182) //= 0x49e. The runtime will prefer the VTID if present
  @VTID(377)
  void sessionSharingKey(String pVal);
   ...
   * </p>
   *
   * @param pGroupId Mandatory String parameter.
   * @return Returns a value of type int
   */

  @DISPID(104) //= 0x68. The runtime will prefer the VTID if present
  @VTID(378)
  int disconnectSessions(String pGroupId);
  ...
  @VTID(379)
  int logoffSessions(String pGroupId);
  ...
  @VTID(380)
  int setSessionGroupId(String pGroupId);
  ...
  @VTID(382)
  int switchSession(int hSession);
  ...
  @VTID(384)
  int getSessionHandleByIndex(int index);
  ...
  @VTID(385)
  int getSessionGroupCount(String pGroupId);
  ...
  @DISPID(1192) //= 0x4a8. The runtime will prefer the VTID if present
  @VTID(389)
  void audioDuringDetach(boolean pVal);
  ...
  @DISPID(1194) //= 0x4aa. The runtime will prefer the VTID if present
  @VTID(393)
  void hotkey11Shift(String pVal);
  ...
  @DISPID(1195) //= 0x4ab. The runtime will prefer the VTID if present
  @VTID(396)
  void virtualCOMPortEmulation(boolean pVal);
  ...
  @VTID(397)
  int setSessionSize(int depth, int hDesiredHres, int hDesiredVres, int bSingleMonitor);
   ...
   *
   * @param channelName Mandatory String parameter.
   * @param pipeName    Mandatory String parameter.
   * @return Returns a value of type boolean
   */

  @DISPID(116) //= 0x74. The runtime will prefer the VTID if present
  @VTID(399)
  boolean createChannelComms(String channelName, String pipeName);
   ...
   * </p>
   *
   * @param ccmSessionID Mandatory String parameter.
   * @param bReserved    Mandatory boolean parameter.
   */

  @DISPID(118) //= 0x76. The runtime will prefer the VTID if present
  @VTID(401)
  void startMonitoringCCMSession(String ccmSessionID, boolean bReserved);
  ...
  @VTID(402)
  void stopMonitoringCCMSession(String ccmSessionID);
  ...
  @VTID(404)
  void setCDMSecuritySettings(int secSetting);
  ...
  @VTID(406)
  void setAudioInSecuritySettings(int secSetting);
  ...
  @VTID(408)
  void setFlashSecuritySettings(int secSetting);
  ...
  @DISPID(1197) //= 0x4ad. The runtime will prefer the VTID if present
  @VTID(410)
  void inXenDesktopViewer(boolean pVal);
  ...
  @VTID(412)
  void setTWAINSecuritySettings(int secSetting);
