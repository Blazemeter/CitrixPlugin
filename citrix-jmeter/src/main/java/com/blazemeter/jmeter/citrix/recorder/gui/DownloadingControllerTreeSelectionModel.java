 ...
 */
class DownloadingControllerTreeSelectionModel extends DefaultTreeSelectionModel {
	 ...
	 * {@link CitrixRecorderGUI#isValidDownloadingController}
	 * </p>
	 * 
	...
	private boolean isValidDownloadingControllerNode(DefaultMutableTreeNode node) {
		...
		return modelNode != null && TestPlanHelper.isValidDownloadingController(modelNode.getTestElement());
	}
	...
	public void setSelectionPath(TreePath path) {
		...
		applyWhenValid((DefaultMutableTreeNode) path.getLastPathComponent(), () -> super.setSelectionPath(path));
	}
	...
	public void addSelectionPath(TreePath path) {
		...
		applyWhenValid((DefaultMutableTreeNode) path.getLastPathComponent(), () -> super.addSelectionPath(path));
	}
