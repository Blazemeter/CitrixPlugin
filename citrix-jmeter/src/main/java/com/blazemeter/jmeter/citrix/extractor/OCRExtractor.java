	...
	public void process() {
		...
		if (previousResult instanceof CitrixSampleResult) {
			...
			if (StringUtils.isBlank(refName)) {
				throw new IllegalArgumentException("Variable name is required for ScreenExtractor " + getName());
			}
			...
			if (snapshot != null) {
				try {
					...
					String value = ClauseHelper.recognize(snapshot.getScreenshot(), area);
