...
public class BlazeMeterLabsLogo extends JPanel {
	...
	private static final ImageIcon DARK_LOGO = new ImageIcon(
			BlazeMeterLabsLogo.class.getResource("/com/blazemeter/labs-logo/blazemeter-labs-light-logo.png"));
	private static final String URL_TO_BROWSE = "https://github.com/Blazemeter/CitrixPlugin";

	private JLabel blazeMeterLabsLogo;
	...
	public void paint(Graphics g) {
		blazeMeterLabsLogo.setIcon("Darcula".equals(UIManager.getLookAndFeel().getID()) ? DARK_LOGO : DEFAULT_LOGO);
		super.paint(g);
	}
