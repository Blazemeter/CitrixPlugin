...
public class CitrixSessionAssertion extends AbstractTestElement implements Serializable, Assertion {
  ...
  public AssertionResult getResult(SampleResult response) {
    ...
    boolean success = (getExpectedState() == SessionState.OPEN) == connected;
    result.setFailure(!success);
    result.setFailureMessage(
        STATE_MESSAGE_FORMAT.format(new Object[] {getExpectedState(),
            connected ? SessionState.OPEN : SessionState.CLOSED}));
    return result;
  }
