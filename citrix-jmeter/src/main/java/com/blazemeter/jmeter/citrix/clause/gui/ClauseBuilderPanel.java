...
public class ClauseBuilderPanel extends JPanel implements ActionListener, DragGestureListener {
  ...
  static {
    ...
    try (InputStream stream = ClauseBuilderPanel.class
      ...
      cursor = Toolkit.getDefaultToolkit()
          .createCustomCursor(icon.getImage(), new Point(), "dnd_clause");
  ...
  public void setCheckTypes(Set<CheckType> checkTypes) {
    ...
    while (buttonEnum.hasMoreElements()) {
      ...
      currentButton.setVisible(
          this.checkTypes
              .contains(Enum.valueOf(CheckType.class, currentButton.getActionCommand())));
    }
  ...
  public void setSelection(Rectangle selection, boolean relative) {
    Rectangle absoluteSelection =
        ClauseHelper.getAbsoluteSelection(selection, relative, pnlImage.getHighlight());
  ...
  private void triggerClauseChanged() {
    ...
    for (ClauseChangedListener listener : listeners) {
      listener.onClauseChanged(new ClauseChangedEvent(this, clause));
    }
  }
  ...
  private JPanel createToolbar() {
    ...
    lblDrag = new JLabel(CitrixUtils.getResString("clause_builder_drag", false), DND_ICON,
    ...
    pnlPosition.setBorder(
        new TitledBorder(null, CitrixUtils.getResString("clause_builder_position", false),
    ...
    pnlSelection.setBorder(
        new TitledBorder(null, CitrixUtils.getResString("clause_builder_selection", false),
            TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    if (clause != null) {
      dge.startDrag(DND_CURSOR, new Transferable() {
        ...
        public Object getTransferData(DataFlavor flavor)
          ...
          assertion.setName(
              MessageFormat
                  .format(CitrixUtils.getResString("clause_builder_new_assertion_fmt", false),
                      clause.getCheckType()));
