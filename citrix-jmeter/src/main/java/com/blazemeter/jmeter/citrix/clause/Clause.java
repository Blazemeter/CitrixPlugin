...
public class Clause implements Serializable {
	 ...
	 */
	public Clause(CheckType checkType, String expectedValue, boolean usingRegex, Rectangle selection) {
		if (checkType == null) {
	...
	public Clause(CheckType checkType, BufferedImage screenshot, Rectangle selection)
		...
		this(checkType, checkType.assess(screenshot, selection), false, selection);
	}
}
