...
public class ListeningStrategy implements CheckStrategy {
  ...
  public boolean wait(Clause clause, CitrixClient client, CheckResultCallback onCheck)
    ...
    LOGGER.debug("Starts listening Citrix windows events at {} with timeout={}",
    ...
    try {
      ...
      LOGGER.debug("Stops listening Citrix windows events at {} with expired={}",
          System.currentTimeMillis(),
          expired);
    }
  ...
  private class WindowEventListener extends CitrixClientAdapter {
    ...
    WindowEventListener(Clause clause, CheckResultCallback onCheck) {
    ...
    public void handleWindowEvent(WindowEvent windowEvent) {
      ...
      if (LOGGER.isTraceEnabled()) {
        ...
        LOGGER
            .trace("Event {} occurred on window '{}' is expected: {}", windowEvent.getWindowState(),
