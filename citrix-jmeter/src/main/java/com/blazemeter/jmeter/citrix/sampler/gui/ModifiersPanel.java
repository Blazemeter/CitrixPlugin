...
public class ModifiersPanel extends JPanel {
  ...
  private void triggerModifiersChanged() {
    ModifiersChangedListener[] listeners =
        listenerList.getListeners(ModifiersChangedListener.class);
    for (ModifiersChangedListener listener : listeners) {
      listener.onModifiersChanged(new ModifiersChangedEvent(this, modifiers));
    }
  }
  ...
  public interface ModifiersChangedListener extends EventListener {
