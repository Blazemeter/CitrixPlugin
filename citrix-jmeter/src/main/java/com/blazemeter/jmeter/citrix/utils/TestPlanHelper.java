...
public class TestPlanHelper {
	 ...
	 * 
	 * <p>
	 * A pre-filtering is done with {@link#isAllowedDownloadingControllerElement}
	 * </p>
	 * 
	 ...
	 */
	public static JMeterTreeNode findNodeByPath(JMeterTreeNode node, List<JMeterProperty> path, int level) {
