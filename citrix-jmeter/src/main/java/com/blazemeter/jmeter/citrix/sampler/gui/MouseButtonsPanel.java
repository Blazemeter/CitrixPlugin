...
public class MouseButtonsPanel extends JPanel {
  ...
  private void triggerButtonsChanged() {
    ...
    for (ButtonsChangedListener listener : listeners) {
      listener.onButtonsChanged(new ButtonsChangedEvent(this, buttons));
    }
  }
  ...
  public interface ButtonsChangedListener extends EventListener {
